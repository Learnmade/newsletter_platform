...
import { Calendar, Clock, ChevronRight, ChevronLeft, Loader2, CheckCircle2, User, Mail, MessageSquare } from 'lucide-react';
    ...
    const handleBooking = async (e) => {
        ...
        try {
            ...
            if (json.success) {
                ...
                // Refresh slots in case someone else booked it
            ...
            <div className="min-h-screen bg-gray-50 flex flex-col">
                ...
                <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
                    ...
                    <p className="text-gray-600 max-w-md mx-auto mb-8 leading-relaxed">
                        Your 1-on-1 mentorship slot for <strong>{selectedDate?.toLocaleDateString('en-US', { weekday: 'long', month: 'short', day: 'numeric' })}</strong> at <strong>{selectedSlot}</strong> has been reserved.
                    </p>
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 max-w-md mx-auto text-sm text-gray-700 mb-8">
                        ...
                        <p>We are currently operating in manual payment mode. Please look out for an email from <strong>support@learnmade.in</strong> with instructions to finalize your booking.</p>
                    </div>
                    <Link href="/" className="bg-blue-700 text-white px-8 py-3 rounded-xl font-bold hover:bg-blue-800 transition-colors shadow-sm">
                        Return to Homepage
                    </Link>
                </div>
            </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input 
                                        ...
                                        className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-300 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-600 outline-none transition-all text-sm font-medium"
